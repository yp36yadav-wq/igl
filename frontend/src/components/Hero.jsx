                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    {/* CTA Button */}
                     {/* <button
                        ...
                        className="group bg-black hover:bg-gray-800 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg transition-all shadow-lg hover:shadow-xl flex items-center justify-center mx-auto gap-2 hover:-translate-y-0.5 active:translate-y-0"
                    >
                        Book Appointment
                    ...
                    <div className="mt-12 sm:mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 max-w-4xl mx-auto">
                        <div className="text-center p-4 sm:p-6 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                            <div className="text-3xl sm:text-4xl font-bold text-black mb-2">Fast</div>
                            <p className="text-sm sm:text-base text-gray-600">Quick Service</p>
                        </div>
                        <div className="text-center p-4 sm:p-6 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                            <div className="text-3xl sm:text-4xl font-bold text-black mb-2">Reliable</div>
                            <p className="text-sm sm:text-base text-gray-600">Trusted Quality</p>
                        </div>
                        <div className="text-center p-4 sm:p-6 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                            <div className="text-3xl sm:text-4xl font-bold text-black mb-2">24/7</div>
                            <p className="text-sm sm:text-base text-gray-600">Always Available</p>
                        </div>
                    </div>
                </div>
            </section>
