    ...
    return (
        <span>
            ...
            <motion.span
                ...
                className="inline-block w-1 h-8 md:h-12 bg-blue-400 ml-1 align-middle"
            />
        </span>
    );
};
...
const Hero = () => {
    ...
    return (
        <section id="home" className="relative bg-gradient-to-br from-slate-900 to-blue-900 text-white py-24 lg:py-32 overflow-hidden h-[600px] flex items-center justify-center">
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                ...
                <button onClick={() => document.getElementById('booking').scrollIntoView({ behavior: 'smooth' })} className="group bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all shadow-[0_0_40px_-10px_rgba(59,130,246,0.5)] hover:shadow-[0_0_60px_-15px_rgba(59,130,246,0.6)] flex items-center justify-center mx-auto gap-2">
                    Book Appointment
