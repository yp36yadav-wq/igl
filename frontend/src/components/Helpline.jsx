...
export default function HelplinePage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#0b3d2e] via-[#0a2f23] to-[#083821] py-12 px-4">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:items-start">
                    ...
                    <div className="bg-white rounded-3xl p-8 md:p-10 shadow-2xl transform hover:scale-[1.02] transition-all duration-300 flex flex-col h-full">
